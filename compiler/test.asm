...
section .data
	...
	result dq 0
	w0 db "Menu", 10, 0
	w1 db "[1] Add two numbers", 10, 0
	w2 db "[2] Subtract two numbers", 10, 0
	w3 db "[3] Multiply two numbers", 10, 0
	w4 db "[4] Divide two numbers", 10, 0
	w5 db "Enter a number: ", 0
	w6 db "Enter a number1: ", 0
	w7 db "Enter a number2: ", 0
	d0 dq 1
	d1 dq 1
